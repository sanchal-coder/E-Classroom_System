...
<body>
	<h2>
		<font face="WildWest" color="blue">Enter Your Study Materials Here</font>
	</h2>
	<form action="oes.controller.stdyMatrlInsert">
		<pre>

       <div class="form-group">
    <label for="source">Source:</label>
    <input type="text" class="form-control col-sm-6" id="source" name="source">
</div>
<div class="form-group">
    ...
    <textarea class="form-control col-sm-6" id="description" name="description"></textarea>
             ...
             <input type="submit" value="Add"
				...
				onclick="location.href='studyMaterial.jsp'"value="Back"
